...
public class HangmanArenaCampaignScreen extends AbstractScreen<HangmanArenaScreenManager> {
    ...
    public HangmanArenaCampaignScreen() {
    ...
    private Table createButtonTable(CampaignLevel levelEnum) {
        ...
        MyButton levelBtn = new CampaignLevelButtonBuilder(getAbstractScreen(), levelEnum, campaignLevel)
                .setLevelLocked(campaignLevel == null && levelEnum.getIndex() != 0 && !HangmanArenaGame.getInstance().getAppInfoService().isScreenShotMode()).build();
