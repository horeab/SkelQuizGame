package libgdx.screens.implementations.animals;
...
import libgdx.screens.implementations.animals.spec.HangmanHeaderCreator;
import libgdx.screens.implementations.animals.spec.HangmanScreenBackgroundCreator;
import libgdx.utils.ScreenDimensionsManager;
import libgdx.utils.Utils;

import java.util.ArrayList;

public class AnimalsGameScreen extends GameScreen<AnimalsScreenManager> {
    ...
    public AnimalsGameScreen(GameContext gameContext, CampaignLevel campaignLevel) {
        super(gameContext);
