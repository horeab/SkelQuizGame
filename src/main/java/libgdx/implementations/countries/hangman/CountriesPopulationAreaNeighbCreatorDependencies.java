...
public class CountriesPopulationAreaNeighbCreatorDependencies extends CreatorDependencies {
    ...
    private Map<Integer, CountriesPopulationAreaNeighbGameService> gameService = new HashMap<>();
    ...
    public GameService getGameService(Question question) {
        ...
        if (gameService.get(l) == null) {
            gameService.put(l, new CountriesPopulationAreaNeighbGameService(question, manager.getAllCountries(), manager.getCategQuestions((CountriesCategoryEnum) question.getQuestionCategory()), manager.getSynonyms()));
        }
    ...
    public QuestionContainerCreatorService getQuestionContainerCreatorService(GameContext gameContext, GameScreen screen) {
        return new CountriesPopulationAreaNeighbQuestionContainerCreatorService(gameContext, (CountriesGameScreen) screen);
    }
