...
public class CountriesPopulationAreaNeighbCreatorDependencies extends CreatorDependencies {
    ...
    public GameService getGameService(Question question) {
        ...
        return new CountriesPopulationAreaNeighbGameService(question, manager.getAllCountries(), manager.getCategQuestions((CountriesCategoryEnum) question.getQuestionCategory()), manager.getSynonyms());
    }
